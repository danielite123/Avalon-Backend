...
const forgotPasswordToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    await user.save();
    const resetURL =
      "Hi Please follow this link to reset Your Password. This link is valid till 10minutes from now. <a href='http://localhost:5000/api/user/reset-password/${token}'>Click Here</a>";
    const data = {
      to: email,
      text: "Hey User",
